    ...
    <main class="grid h-screen w-full lg:grid-cols-2">
        ...
        <div class="flex items-center justify-center bg-white p-7 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <h1 class="mt-10 text-3xl font-semibold tracking-tight">Create your account</h1>
                <p class="mt-2 text-slate-500">Start planning with a free personal workspace.</p>
