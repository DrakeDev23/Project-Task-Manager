...
class EmailSystemTest extends TestCase
{
    ...
    {
        Notification::fake();
        $this->post(route('register.store'), ['name' => 'A Unique User', 'email' => 'new@example.com', 'password' => 'password123', 'password_confirmation' => 'password123'])
            ->assertRedirect(route('dashboard'));
        Notification::assertSentTo(User::whereEmail('new@example.com')->first(), VerifyEmailNotification::class);
    }
